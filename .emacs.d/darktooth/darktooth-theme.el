...
(let (
      (darktooth-dark0_hard      (if (display-graphic-p) "#1C1D1F" "color-234"))
      (darktooth-dark0           (if (display-graphic-p) "#232426" "color-235"))
      (darktooth-dark0_soft      (if (display-graphic-p) "#2F3033" "color-236"))
      (darktooth-dark1           (if (display-graphic-p) "#3B3C40" "color-237"))
      (darktooth-dark2           (if (display-graphic-p) "#47484D" "color-239"))
      (darktooth-dark3           (if (display-graphic-p) "#525359" "color-241"))
      (darktooth-dark4           (if (display-graphic-p) "#5E5F66" "color-243"))

      (darktooth-medium          (if (display-graphic-p) "#928374" "color-245")) ;; or 244

      (darktooth-light0_hard     (if (display-graphic-p) "#D9C6AA" "color-230"))
      (darktooth-light0          (if (display-graphic-p) "#CCBAA0" "color-229"))
      (darktooth-light0_soft     (if (display-graphic-p) "#BFAE96" "color-228"))
      (darktooth-light1          (if (display-graphic-p) "#B3A38C" "color-223"))
      (darktooth-light2          (if (display-graphic-p) "#A69782" "color-250"))
      (darktooth-light3          (if (display-graphic-p) "#998B78" "color-248"))
      (darktooth-light4          (if (display-graphic-p) "#8C7F6E" "color-246"))
