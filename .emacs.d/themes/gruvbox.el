...
(defun create-gruvbox-theme (variant theme-name)
  ...
  (let ((gruvbox-dark-0-hard (if (display-graphic-p) "#1d2021" "color-234"))
        ...
        (gruvbox-light-0-hard (if (display-graphic-p) "#f9f5d7" "color-230"))
        (gruvbox-light-0      (if (display-graphic-p) "#fbf1c7" "color-229"))
    ...
    (custom-theme-set-faces
     ...
     `(error                       ((t (:foreground ,gruvbox-red :weight bold))))
     ...
     `(link                        ((t (:foreground ,gruvbox-blue))))
     `(linum                       ((t (:foreground ,gruvbox-dark4))))
     `(minibuffer-prompt           ((t (:background ,gruvbox-dark0 :foreground ,gruvbox-green))))
     `(mode-line                   ((t (:background ,gruvbox-aqua :foreground ,gruvbox-dark0 :box nil))))
     `(mode-line-inactive          ((t (:background ,gruvbox-light4 :foreground ,gruvbox-dark0 :box nil))))
     `(region                      ((t (:background ,gruvbox-dark2))))
     `(secondary-selection         ((t (:background ,gruvbox-dark1))))
     `(shadow                      ((t (:foreground ,gruvbox-light4))))
     ...
     `(warning                     ((t (:foreground ,gruvbox-orange :weight bold))))
     ...
     `(font-lock-warning-face       ((t (:foreground ,gruvbox-orange :weight bold))))
     ...
     ;;; org
     `(org-code           ((t (:foreground ,gruvbox-aqua))))
     `(org-document-title ((t (:foreground ,gruvbox-yellow :weight bold))))
     `(org-document-info  ((t (:foreground ,gruvbox-purple))))
     `(org-done           ((t (:foreground ,gruvbox-aqua :weight bold))))
     `(org-level-1        ((t (:foreground ,gruvbox-red :weight bold))))
     `(org-level-2        ((t (:foreground ,gruvbox-blue :weight bold))))
     `(org-level-3        ((t (:foreground ,gruvbox-green :weight bold))))
     `(org-level-4        ((t (:foreground ,gruvbox-orange))))
     `(org-level-5        ((t (:foreground ,gruvbox-purple))))
     `(org-level-6        ((t (:foreground ,gruvbox-yellow))))
     `(org-level-7        ((t (:foreground ,gruvbox-aqua))))
     `(org-level-8        ((t (:foreground ,gruvbox-gray))))
     `(org-list-dt        ((t (:foreground ,gruvbox-light4 :weight bold))))
     `(org-table          ((t (:foreground ,gruvbox-light3))))
     `(org-todo           ((t (:foreground ,gruvbox-yellow :weight bold))))

     ;;; popup
     `(popup-face                       ((t (:background ,gruvbox-dark1 :foreground ,gruvbox-light1))))
     `(popup-menu-mouse-face            ((t (:background ,gruvbox-purple :foreground ,gruvbox-dark1))))
     `(popup-menu-selection-face        ((t (:background ,gruvbox-dark2 :foreground ,gruvbox-light1))))
     `(popup-scroll-bar-background-face ((t (:background ,gruvbox-dark1))))
     `(popup-scroll-bar-foreground-face ((t (:background ,gruvbox-dark2))))
     `(popup-tip-face                   ((t (:background ,gruvbox-dark1 :foreground ,gruvbox-yellow))))

     ;;; powerline
     `(powerline-active1   ((t (:background ,gruvbox-dark2 :foreground ,gruvbox-light1))))
     `(powerline-active2   ((t (:background ,gruvbox-dark1 :foreground ,gruvbox-light1))))
     `(powerline-inactive1 ((t (:background ,gruvbox-dark2 :foreground ,gruvbox-light1))))
     `(powerline-inactive2 ((t (:background ,gruvbox-dark1 :foreground ,gruvbox-light1))))
     ...
     ;;; spaceline
     `(spaceline-evil-normal  ((t (:background ,gruvbox-blue :foreground ,gruvbox-dark0))))
     `(spaceline-evil-insert  ((t (:background ,gruvbox-yellow :foreground ,gruvbox-dark0))))
     `(spaceline-evil-visual  ((t (:background ,gruvbox-purple :foreground ,gruvbox-dark0))))
     `(spaceline-evil-motion  ((t (:background ,gruvbox-green :foreground ,gruvbox-dark0))))
     `(spaceline-evil-replace ((t (:background ,gruvbox-orange :foreground ,gruvbox-dark0))))
     `(spaceline-evil-emacs   ((t (:background ,gruvbox-red :foreground ,gruvbox-dark0))))
