...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP_ANSI(
        ...
        FN0,LGUI,LALT,          SPC,                     CAPS, RGUI,APP, RCTL),
    /* 1: colemak */
    KEYMAP_ANSI(
        GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC, \
     ...
     */
    KEYMAP_ANSI(
        FN1, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, DEL,  \
        TRNS ,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,PGUP,UP,PGDN,TRNS,TRNS,TRNS, TRNS, \
        TRNS  ,TRNS,TRNS,TRNS,TRNS,TRNS,HOME,LEFT,DOWN,RIGHT,INS, DEL,   TRNS, \
